...
### PHP 7.4
if [ -d "/RunCloud/Packages/php74rc/" ]
then
    echo "Install ioncube Loader for PHP 7.4"
    sudo cp ioncube/ioncube_loader_lin_7.4.so /RunCloud/Packages/php74rc/lib/php/extensions/no-debug-non-zts-20190902/
